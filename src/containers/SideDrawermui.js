...
import Shortsmui from '../components/Shortsmui';
...
export default function SideDrawermui() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
        ...
        <List>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={() => setMenudata("Shorts")}>
              ...
              >
                ...
                >
                  <AiFillVideoCamera style={{fontSize : '25px'}}/>
                </ListItemIcon>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
       {menudata === 'Home' && <Homemui />}
       {menudata === 'Shorts' && <Shortsmui />}
      </Box>
    </Box>
  );
}